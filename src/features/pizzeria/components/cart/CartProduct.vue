...
async function cartGsapAnimation() {
  const tl = gsap.timeline()

  await nextTick()

  tl.from('.cart-page__subtitle', {
    opacity: 0,
    duration: 0.7,
    y: 30,
    ease: 'power3.out',
  ...
  <section class="cart-page">
    <div class="cart-page__container">
      <div class="cart-page__heading">
        ...
        <h1 class="cart-page__title">Panier</h1>
      ...
      <div v-if="cartStore.cart.length > 0" class="cart-layout">
        ...
        <aside class="cart-summary">
          ...
          <button class="cart-summary__checkout" @click="redirectCommand()">Commander</button>
        </aside>
      </div>
